    ...
    <div className='flex items-center justify-center min-h-screen px-6 sm:px-0 bg-gradient-to-br from-blue-200 to-purple-400 '>
        ...
        <div className='bg-slate-900 p-10 rounded-lg shadow-lg w-full sm:w-96 text-indigo-300 text-sm'>
            ...
            <form onSubmit={onSubmitHandler}>
                ...
                <button className='w-full py-2.5 rounded-full bg-gradient-to-r from-indigo-500 to-indigo-900 text-white font-medium'>{state == 'Sign up' ? 'Sign Up': 'Log In'}</button>
                </form>
                ...
                <p className='text-gray-400 text-center text-xs mt-4'>Dont have an Account <span onClick={()=> setstate('Sign up')} className='text-blue-400 cursor-pointer underline'>Sign Up</span></p>
}
        </div>
    </div>
  )
